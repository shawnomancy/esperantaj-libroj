...
\newfontfamily\arbfont{TeX Gyre Bonum}[LetterSpace=10]
...
\newfontfamily\chunk{Roboto Slab}[LetterSpace=5]
%\newfontfamily\stoke{Amethysta}
...
\newfontfamily\bookman{TeX Gyre Bonum}[LetterSpace=5]
...
% tabularray kaj kolonoj
%
\usepackage{tabularray}
\usepackage{array,ragged2e}
\NewColumnType{Y}[1][]{Q[c,co=1,#1]}

%
% temo por simplaj tabeloj
%
\NewTblrTheme{plain}{
\DefTblrTemplate{contfoot-text}{blank}{}
\SetTblrTemplate{contfoot-text}{blank}
\DefTblrTemplate{conthead-text}{blank}{}
\SetTblrTemplate{conthead-text}{blank}
...
% 
\usepackage{soul}
\sodef\spaceoutmore{}{.4em}{0.6em}{0pt}
...
% 
\newcommand{\pstars}{%
\hspace*{\fill} * \hspace{2em} \raisebox{-0.7em}{*} \hspace{2em} * \hspace*{\fill}}
...
%
\renewcommand{\,}{%
{\relsize{-1.5}\raisebox{-1.5ex}{\textnormal{\textquotesingle}}}}
