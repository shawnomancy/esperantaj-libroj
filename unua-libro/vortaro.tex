...
\begin{tblr}{width=19cm,colspec={X|X|X}}
\parbox{5.85cm}{
{\hfil \small \leftpointright{} \sansfont{EVERYTHING} \rightpointleft}

\vspace{1ex}
\footnotesize written in the international language can be translated by means of this vocabulary. If several words are required to express one idea they must be written \parfillskip=0pt
}
&
\parbox{6cm}{
\begin{center}
...
% This rather amazing piece of code comes from:
% https://tex.stackexchange.com/questions/280017/center-last-line-of-the-paragraph-but-i-dont-like-small-lines
% It builds the paragraph, then unrolls it, then rebuilds the last line with hfills to center it,
% then puts all that in the parbox.
%
{
\setbox0=\vbox{\footnotesize in one, but separated by commas; e.~g., \emph{frat\,in\,o}, though one idea, is yet \mbox{composed} of three words, which must be \mbox{looked} for separately in the \mbox{vocabulary.}}
\setbox1=\vbox{%
\unvbox0
\setbox2=\lastbox
\hbox to 5.85cm{\hfill\unhcopy2 \unskip\hfill}}
\parbox{5.85cm}{\unvbox1}
}
\end{tblr}
