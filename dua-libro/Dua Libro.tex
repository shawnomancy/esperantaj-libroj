...
\begin{center}
\scalebox{0.8}[1]{\latinia{\huge D\doktororo{} ESPERANTO.}}
...
\scalebox{2.1}[1.8]{\shadowtext{\cowboyfont{\LARGE INTERNACIA}}}
...
{\centering\scalebox{1.6}[1]{\didotfont{\textbf{POPOLDIROJ.}}}\par}
