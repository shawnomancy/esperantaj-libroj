...
\SetRow{font=\scriptsize} â & b & ts (tsar) & tch (tchèque) & d & é & f \\[1ex]
\SetRow{font=\Large\arbfont} Gg, & Ĝĝ, & Hh, & Ĥĥ, & Ii, & Jj, & Ĵĵ, \\
\SetRow{font=\scriptsize} g dur~(gant) & dj (adjudant) & h légère\-ment aspiré & h~forte\-ment aspiré & i & y (yeux) & j \\[1ex]
\SetRow{font=\Large\arbfont} Kk, & Ll, & Mm, & Nn, & Oo, & Pp, & Rr, \\
\SetRow{font=\scriptsize} k & l & m & n & ô & p & r \\[1ex]
\SetRow{font=\Large\arbfont} Ss, & Ŝŝ, & Tt, & Uu, & Ŭŭ, & Vv, & Zz. \\
\SetRow{font=\scriptsize} ss, ç & ch (chat) & t & ou & ou bref (dans l‘alle\-mand „laut„) & v & z 
\end{tblr}
\end{center}
